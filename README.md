...
var mp3encoder = new lamejs.Mp3Encoder(1, 44100, 44100, 128); //mono 44.1khz encode to 128kbps
...
mp3encoder = new lamejs.Mp3Encoder(channels, sampleRate, sampleRate, kbps);
var mp3Data = [];
...
<script src='lame.all.js'></script>
<script>
mp3encoder = new lamejs.Mp3Encoder(2, 44100, 44100, 128);
var mp3Data = [];
